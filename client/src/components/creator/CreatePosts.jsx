...
const CreatePosts = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-lg mx-auto mt-16 bg-gradient-to-b from-[#111827] via-[#1f2937] to-[#111827] 
        text-gray-100 rounded-2xl shadow-2xl border border-gray-800 p-6 sm:p-8 relative overflow-hidden"
    >
